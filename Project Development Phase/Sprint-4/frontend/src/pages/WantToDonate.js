...
<form className={styles.form}>
   ...
   <label  className={styles.label}>State</label>
    ...
    <div className={styles.inputdiv}> <input type="text" className={styles.input}  onChange={changeHandler.bind(this,'state')}  placeholder="Tamilnadu" ></input></div>
    </div>
    <div className={styles.question}>
    ...
    <div className={styles.inputdiv}>  <input type="text"  onChange={changeHandler.bind(this,'city')}  placeholder="Ariyalur" className={styles.input} ></input></div>
    </div>
    <div className={styles.question}>
